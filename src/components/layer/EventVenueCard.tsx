  ...
  return (
    ...
    >
      ...
      <CardContent className="text-white">
        <CardTitle className="font-heading text-lg sm:text-xl font-bold uppercase tracking-wide">
          {title}
        </CardTitle>
        ...
        <div className=" text-gray-900">
          ...
          {infoText && (
            <Button
              ...
              className="p-0 mt-1 text-[10px] sm:text-xs font-semibold text-white/90 hover:text-white underline underline-offset-2"
            >
