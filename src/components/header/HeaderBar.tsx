    ...
    <div className="absolute top-0 start-0 end-0 z-30">
      <div
        className="flex items-center w-full mx-auto gap-2 sm:gap-4
                        backdrop-blur-sm bg-white/70 px-2 sm:px-4 py-1.5 sm:py-2 shadow-md"
      >
        {/* left: logo */}
        ...
        {/* center: title */}
        <h1 className="font-heading flex-1 min-w-0 px-1 text-sm font-semibold text-gray-900 text-center leading-tight whitespace-normal break-words sm:px-2 sm:text-lg sm:truncate">
          {t("title")}
        </h1>
